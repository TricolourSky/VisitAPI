...
- **Branching dialogue** with narration, `{player}` placeholders, and a background **image or video** (looping or play-once).
...
- **`.dlg` script reference** — [docs/DLG_FORMAT.md](docs/DLG_FORMAT.md) ([中文](docs/DLG_FORMAT.zh-CN.md)). The release zip does not bundle `docs/` — read it in the source repository: <https://github.com/TricolourSky/VisitAPI>
