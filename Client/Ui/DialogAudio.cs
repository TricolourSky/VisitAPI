...
public class DialogAudio : MonoBehaviour
{
    ...
    public static void Attach(ClientDialogController controller, GameObject host)
    {
        ...
        a._voice = host.AddComponent<AudioSource>();
        a._voice.spatialBlend = 0f;
        a._bgm = host.AddComponent<AudioSource>();
        a._bgm.spatialBlend = 0f; a._bgm.loop = true; a._bgm.volume = 0.5f;
