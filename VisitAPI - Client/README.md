...
- `.dlg` script reference — [docs/DLG_FORMAT.en.md](docs/DLG_FORMAT.en.md)
- Full guide — [docs/GUIDE.md](docs/GUIDE.md)

中文文档:[DLG_FORMAT.md](docs/DLG_FORMAT.md) · [GUIDE.zh-CN.md](docs/GUIDE.zh-CN.md)

## Version

`0.2.3` · SPT 4.0.13 · MIT
